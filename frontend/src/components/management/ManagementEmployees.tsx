...
import type { EmployeeDirectoryRow } from "@shared/contracts/employee-types";
import {
  getEmployeeDetailAction,
  updateManagedEmployeeAction,
} from "@frontend/app/employees/actions";
import { inviteEmployeeAction } from "@frontend/app/employees/invite-actions";
