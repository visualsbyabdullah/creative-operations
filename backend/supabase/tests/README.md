...
supabase start
supabase db reset
psql "$env:LOCAL_SUPABASE_DB_URL" -v ON_ERROR_STOP=1 -f backend/supabase/tests/auth_security.sql
psql "$env:LOCAL_SUPABASE_DB_URL" -v ON_ERROR_STOP=1 -f backend/supabase/tests/core_schema.sql
```
