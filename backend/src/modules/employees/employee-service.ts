...
import { mapEmployee, mapEmployeeDetail } from "@backend/modules/employees/employee-mappers";
import {
  getEmployeeRow,
  listEmployeeRows,
...
} from "@backend/modules/employees/employee-schemas";
import type { EmployeeDetail, EmployeeDirectoryRow } from "@shared/contracts/employee-types";
import type { ActionResult } from "@shared/contracts/action-result";
import { encodeEmployeeCursor } from "@backend/modules/employees/employee-cursor";
import {
